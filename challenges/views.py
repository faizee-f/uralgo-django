...
class ChallengeDetail(APIView):
    ...
    def put(self, request, pk):
        ...
        if challenge.created_by == user:
            ...
            if serializer.is_valid():
                ...
                return Response(
                    {
                        "success": "Your challenge data has been updated successfully"
                    },
                    serializer.data,
            ...
            return Response(
                {"error": "Unautherized"}, status=status.HTTP_401_UNAUTHORIZED
            )
    ...
    def delete(self, request, pk):
        ...
        try:
            ...
            challenge.delete()
            return Response(
                {"success": "Challenge has been deleted successfully"},
